...
export namespace LockupContractDeployedThroughFactoryEvent {
...
type LockupContractFactoryTypedContractMethods<M extends Modifiers> = {
	...
	[K in `set${Uppercase<M['lqty']>}TokenAddress`]: TypedContractMethod<
...
type LockupContractFactoryTypedContractEventFilters<M extends Modifiers> = {
	'LockupContractDeployedThroughFactory(address,address,uint256,address)': TypedContractEvent<
		LockupContractDeployedThroughFactoryEvent.InputTuple,
		LockupContractDeployedThroughFactoryEvent.OutputTuple,
		LockupContractDeployedThroughFactoryEvent.OutputObject
	>;
...
export type LockupContractFactory<M extends Modifiers> = BaseContract &
	...
	getEvent(key: 'LockupContractDeployedThroughFactory'): TypedContractEvent<LockupContractDeployedThroughFactoryEvent.InputTuple, LockupContractDeployedThroughFactoryEvent.OutputTuple, LockupContractDeployedThroughFactoryEvent.OutputObject>;
