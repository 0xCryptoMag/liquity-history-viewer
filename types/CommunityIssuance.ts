...
export namespace StabilityPoolAddressSetEvent {
...
export namespace TotalLQTYIssuedUpdatedEvent {
...
type CommunityIssuanceTypedContractEventFilters<M extends Modifiers> = {
	...
	'StabilityPoolAddressSet(address)': TypedContractEvent<
		StabilityPoolAddressSetEvent.InputTuple,
		StabilityPoolAddressSetEvent.OutputTuple,
		StabilityPoolAddressSetEvent.OutputObject
	>;
	...
	[K in `Total${Uppercase<M['lqty']>}IssuedUpdated(uint256)`]: TypedContractEvent<
		TotalLQTYIssuedUpdatedEvent.InputTuple,
		TotalLQTYIssuedUpdatedEvent.OutputTuple,
		TotalLQTYIssuedUpdatedEvent.OutputObject
	>;
} & {
...
export type CommunityIssuance<M extends Modifiers> = BaseContract &
	CommunityIssuanceTypedContractMethods<M> & {
		...
		getFunction(nameOrSignature: 'LQTYSupplyCap'): TypedContractMethod<[], [bigint], 'view'>;
		...
		getFunction(nameOrSignature: 'issueLQTY'): TypedContractMethod<[], [bigint], 'nonpayable'>;
		getFunction(nameOrSignature: 'lqtyToken'): TypedContractMethod<[], [string], 'view'>;
		getFunction(nameOrSignature: 'owner'): TypedContractMethod<[], [string], 'view'>;
		getFunction(nameOrSignature: 'sendLQTY'): TypedContractMethod<[_account: AddressLike, _LQTYamount: BigNumberish], [void], 'nonpayable'>;
		...
		getFunction(nameOrSignature: 'totalLQTYIssued'): TypedContractMethod<[], [bigint], 'view'>;

		getEvent(key: `${Uppercase<M['lqty']>}TokenAddressSet`): TypedContractEvent<LQTYTokenAddressSetEvent.InputTuple, LQTYTokenAddressSetEvent.OutputTuple, LQTYTokenAddressSetEvent.OutputObject>;
		getEvent(key: 'OwnershipTransferred'): TypedContractEvent<OwnershipTransferredEvent.InputTuple, OwnershipTransferredEvent.OutputTuple, OwnershipTransferredEvent.OutputObject>;
		getEvent(key: 'StabilityPoolAddressSet'): TypedContractEvent<StabilityPoolAddressSetEvent.InputTuple, StabilityPoolAddressSetEvent.OutputTuple, StabilityPoolAddressSetEvent.OutputObject>;
		getEvent(key: `Total${Uppercase<M['lqty']>}IssuedUpdated`): TypedContractEvent<TotalLQTYIssuedUpdatedEvent.InputTuple, TotalLQTYIssuedUpdatedEvent.OutputTuple, TotalLQTYIssuedUpdatedEvent.OutputObject>;
