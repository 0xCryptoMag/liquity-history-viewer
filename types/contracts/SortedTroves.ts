...
export namespace SortedTroves_BorrowerOperationsAddressChangedEvent {
...
export namespace SortedTroves_NodeAddedEvent {
...
export namespace SortedTroves_NodeRemovedEvent {
...
export namespace SortedTroves_OwnershipTransferredEvent {
...
export namespace SortedTroves_SortedTrovesAddressChangedEvent {
...
export namespace SortedTroves_TroveManagerAddressChangedEvent {
...
type SortedTrovesTypedContractEventFilters<M extends Modifiers> = {
	'BorrowerOperationsAddressChanged(address)': TypedContractEvent<
		SortedTroves_BorrowerOperationsAddressChangedEvent.InputTuple,
		SortedTroves_BorrowerOperationsAddressChangedEvent.OutputTuple,
		SortedTroves_BorrowerOperationsAddressChangedEvent.OutputObject
	>;
	...
	'NodeAdded(address,uint256)': TypedContractEvent<
		SortedTroves_NodeAddedEvent.InputTuple,
		SortedTroves_NodeAddedEvent.OutputTuple,
		SortedTroves_NodeAddedEvent.OutputObject
	>;
	...
	'NodeRemoved(address)': TypedContractEvent<
		SortedTroves_NodeRemovedEvent.InputTuple,
		SortedTroves_NodeRemovedEvent.OutputTuple,
		SortedTroves_NodeRemovedEvent.OutputObject
	>;
	...
	'OwnershipTransferred(address,address)': TypedContractEvent<
		SortedTroves_OwnershipTransferredEvent.InputTuple,
		SortedTroves_OwnershipTransferredEvent.OutputTuple,
		SortedTroves_OwnershipTransferredEvent.OutputObject
	>;
	...
	[K in `Sorted${Capitalize<M['trove']>}sAddressChanged(address)`]: TypedContractEvent<
		SortedTroves_SortedTrovesAddressChangedEvent.InputTuple,
		SortedTroves_SortedTrovesAddressChangedEvent.OutputTuple,
		SortedTroves_SortedTrovesAddressChangedEvent.OutputObject
	>;
} & {
	...
	[K in `${Capitalize<M['trove']>}ManagerAddressChanged(address)`]: TypedContractEvent<
		SortedTroves_TroveManagerAddressChangedEvent.InputTuple,
		SortedTroves_TroveManagerAddressChangedEvent.OutputTuple,
		SortedTroves_TroveManagerAddressChangedEvent.OutputObject
	>;
} & {
...
export type SortedTroves<M extends Modifiers> = BaseContract &
	SortedTrovesTypedContractMethods<M> & {
		...
		getEvent(key: 'BorrowerOperationsAddressChanged'): TypedContractEvent<SortedTroves_BorrowerOperationsAddressChangedEvent.InputTuple, SortedTroves_BorrowerOperationsAddressChangedEvent.OutputTuple, SortedTroves_BorrowerOperationsAddressChangedEvent.OutputObject>;
		getEvent(key: 'NodeAdded'): TypedContractEvent<SortedTroves_NodeAddedEvent.InputTuple, SortedTroves_NodeAddedEvent.OutputTuple, SortedTroves_NodeAddedEvent.OutputObject>;
		getEvent(key: 'NodeRemoved'): TypedContractEvent<SortedTroves_NodeRemovedEvent.InputTuple, SortedTroves_NodeRemovedEvent.OutputTuple, SortedTroves_NodeRemovedEvent.OutputObject>;
		getEvent(key: 'OwnershipTransferred'): TypedContractEvent<SortedTroves_OwnershipTransferredEvent.InputTuple, SortedTroves_OwnershipTransferredEvent.OutputTuple, SortedTroves_OwnershipTransferredEvent.OutputObject>;
		getEvent(key: `Sorted${Capitalize<M['trove']>}sAddressChanged`): TypedContractEvent<SortedTroves_SortedTrovesAddressChangedEvent.InputTuple, SortedTroves_SortedTrovesAddressChangedEvent.OutputTuple, SortedTroves_SortedTrovesAddressChangedEvent.OutputObject>;
		getEvent(key: `${Capitalize<M['trove']>}ManagerAddressChanged`): TypedContractEvent<SortedTroves_TroveManagerAddressChangedEvent.InputTuple, SortedTroves_TroveManagerAddressChangedEvent.OutputTuple, SortedTroves_TroveManagerAddressChangedEvent.OutputObject>;
