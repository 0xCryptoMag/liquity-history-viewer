...
type ERC20MockFunctionNameOrSignature =
	| 'allowance'
	| 'approve'
	| 'approveInternal'
	| 'balanceOf'
...
type ERC20MockEventNameOrSignatureOrTopic = 'Approval' | 'Transfer'

export interface ERC20MockInterface extends Interface {
	getFunction(
		nameOrSignature: ERC20MockFunctionNameOrSignature
	): FunctionFragment;

	getEvent(
		nameOrSignatureOrTopic: ERC20MockEventNameOrSignatureOrTopic
	): EventFragment;

	encodeFunctionData(functionFragment: 'allowance', values: [AddressLike, AddressLike]): string;
	encodeFunctionData(functionFragment: 'approve', values: [AddressLike, BigNumberish]): string;
	encodeFunctionData(functionFragment: 'approveInternal', values: [AddressLike, AddressLike, BigNumberish]): string;
	...
	encodeFunctionData(functionFragment: 'transferInternal', values: [AddressLike, AddressLike, BigNumberish]): string;
...
export namespace ERC20Mock_ApprovalEvent {
...
export namespace ERC20Mock_TransferEvent {
...
type ERC20MockTypedContractMethods = {
	...
	approveInternal: TypedContractMethod<[owner: AddressLike, spender: AddressLike, value: BigNumberish], [void], 'nonpayable'>;
	...
	transferInternal: TypedContractMethod<[from: AddressLike, to: AddressLike, value: BigNumberish], [void], 'nonpayable'>;
}

type ERC20MockTypedContractEventFilters = {
	'Approval(address,address,uint256)': TypedContractEvent<
		ERC20Mock_ApprovalEvent.InputTuple,
		ERC20Mock_ApprovalEvent.OutputTuple,
		ERC20Mock_ApprovalEvent.OutputObject
	>;
	...
	'Transfer(address,address,uint256)': TypedContractEvent<
		ERC20Mock_TransferEvent.InputTuple,
		ERC20Mock_TransferEvent.OutputTuple,
		ERC20Mock_TransferEvent.OutputObject
	>;
...
export type ERC20Mock = BaseContract &
	ERC20MockTypedContractMethods & {
		connect(runner?: ContractRunner | null): ERC20Mock;
		waitForDeployment<T>(): Promise<ThisType<T> & ERC20Mock>;
		...
		listeners<TCEvent extends TypedContractEvent, T>(
			event: TCEvent
		...
		getFunction(nameOrSignature: 'approveInternal'): TypedContractMethod<[owner: AddressLike, spender: AddressLike, value: BigNumberish], [void], 'nonpayable'>;
		getFunction(nameOrSignature: 'balanceOf'): TypedContractMethod<[account: AddressLike], [bigint], 'view'>;
		getFunction(nameOrSignature: 'burn'): TypedContractMethod<[account: AddressLike, amount: BigNumberish], [void], 'nonpayable'>;
		...
		getFunction(nameOrSignature: 'mint'): TypedContractMethod<[account: AddressLike, amount: BigNumberish], [void], 'nonpayable'>;
		...
		getFunction(nameOrSignature: 'transferInternal'): TypedContractMethod<[from: AddressLike, to: AddressLike, value: BigNumberish], [void], 'nonpayable'>;

		getEvent(key: 'Approval'): TypedContractEvent<ERC20Mock_ApprovalEvent.InputTuple, ERC20Mock_ApprovalEvent.OutputTuple, ERC20Mock_ApprovalEvent.OutputObject>;
		getEvent(key: 'Transfer'): TypedContractEvent<ERC20Mock_TransferEvent.InputTuple, ERC20Mock_TransferEvent.OutputTuple, ERC20Mock_TransferEvent.OutputObject>;

		filters: ERC20MockTypedContractEventFilters;
	}
