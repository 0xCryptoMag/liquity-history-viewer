...
/**
 * Contains modifiers to apply to the abi for forks that opted to rebrand
 * functions and variables to their own personal brand
 */
export type Modifiers = {
	abisType: 'normal' | 'modified'
	eth: string;
	ether: string;
	lqty: string;
	lusd: string;
...
export type PartialModifiers = {
	abisType: 'normal' | 'modified';
} & Partial<Omit<Modifiers, 'abisType'>>;
