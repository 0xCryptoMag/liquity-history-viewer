...
export namespace PriceFeedTestnet_LastGoodPriceUpdatedEvent {
...
type ActivePoolTypedContractEventFilters = {
	'LastGoodPriceUpdated(uint256)': TypedContractEvent<
		PriceFeedTestnet_LastGoodPriceUpdatedEvent.InputTuple,
		PriceFeedTestnet_LastGoodPriceUpdatedEvent.OutputTuple,
		PriceFeedTestnet_LastGoodPriceUpdatedEvent.OutputObject
	>;
...
export type PriceFeedTestnet = BaseContract &
	ActivePoolTypedContractMethods & {
		...
		getEvent(key: 'LastGoodPriceUpdated'): TypedContractEvent<PriceFeedTestnet_LastGoodPriceUpdatedEvent.InputTuple, PriceFeedTestnet_LastGoodPriceUpdatedEvent.OutputTuple, PriceFeedTestnet_LastGoodPriceUpdatedEvent.OutputObject>;
