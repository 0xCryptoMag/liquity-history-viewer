...
export namespace HintHelpers_OwnershipTransferredEvent {
...
export namespace HintHelpers_SortedTrovesAddressChangedEvent {
...
export namespace HintHelpers_TroveManagerAddressChangedEvent {
...
type HintHelpersTypedTypedContractEventFilters<M extends Modifiers> = {
	'OwnershipTransferred(address,address)': TypedContractEvent<
		HintHelpers_OwnershipTransferredEvent.InputTuple,
		HintHelpers_OwnershipTransferredEvent.OutputTuple,
		HintHelpers_OwnershipTransferredEvent.OutputObject
	>;
	...
	[K in `Sorted${Capitalize<M['trove']>}sAddressChanged(address)`]: TypedContractEvent<
		HintHelpers_SortedTrovesAddressChangedEvent.InputTuple,
		HintHelpers_SortedTrovesAddressChangedEvent.OutputTuple,
		HintHelpers_SortedTrovesAddressChangedEvent.OutputObject
	>;
} & {
	...
	[K in `${Capitalize<M['trove']>}ManagerAddressChanged(address)`]: TypedContractEvent<
		HintHelpers_TroveManagerAddressChangedEvent.InputTuple,
		HintHelpers_TroveManagerAddressChangedEvent.OutputTuple,
		HintHelpers_TroveManagerAddressChangedEvent.OutputObject
	>;
} & {
...
export type HintHelpers<M extends Modifiers> = BaseContract &
	HintHelpersTypedContractMethods<M> & {
		...
		getEvent(key: 'OwnershipTransferred'): TypedContractEvent<HintHelpers_OwnershipTransferredEvent.InputTuple, HintHelpers_OwnershipTransferredEvent.OutputTuple, HintHelpers_OwnershipTransferredEvent.OutputObject>;
		getEvent(key: `Sorted${Capitalize<M['trove']>}sAddressChanged`): TypedContractEvent<HintHelpers_SortedTrovesAddressChangedEvent.InputTuple, HintHelpers_SortedTrovesAddressChangedEvent.OutputTuple, HintHelpers_SortedTrovesAddressChangedEvent.OutputObject>;
		getEvent(key: `${Capitalize<M['trove']>}ManagerAddressChanged`): TypedContractEvent<HintHelpers_TroveManagerAddressChangedEvent.InputTuple, HintHelpers_TroveManagerAddressChangedEvent.OutputTuple, HintHelpers_TroveManagerAddressChangedEvent.OutputObject>;
