...
export interface LUSDTokenInterface<M extends Modifiers> extends Interface {
	...
	encodeFunctionData(functionFragment: `${Uppercase<M['lusd']>}TokenBalanceUpdated`, values?: undefined): string;
	...
	decodeFunctionResult(functionFragment: `${Capitalize<M['trove']>}ManagerAddressChanged`, data: BytesLike): Result;
	decodeFunctionResult(functionFragment: 'version', data: BytesLike): Result;
}

export namespace LUSDToken_ApprovalEvent {
...
export namespace LUSDToken_BorrowerOperationsAddressChangedEvent {
...
export namespace LUSDToken_LUSDTokenBalanceUpdatedEvent {
...
export namespace LUSDToken_StabilityPoolAddressChangedEvent {
...
export namespace LUSDToken_TransferEvent {
...
export namespace LUSDToken_TroveManagerAddressChangedEvent {
...
type LUSDTokenTypedContractEventFilters<M extends Modifiers> = {
	'Approval(address,address,uint256)': TypedContractEvent<
		LUSDToken_ApprovalEvent.InputTuple,
		LUSDToken_ApprovalEvent.OutputTuple,
		LUSDToken_ApprovalEvent.OutputObject
	>;
	...
	'BorrowerOperationsAddressChanged(address)': TypedContractEvent<
		LUSDToken_BorrowerOperationsAddressChangedEvent.InputTuple,
		LUSDToken_BorrowerOperationsAddressChangedEvent.OutputTuple,
		LUSDToken_BorrowerOperationsAddressChangedEvent.OutputObject
	>;
	...
	'StabilityPoolAddressChanged(address)': TypedContractEvent<
		LUSDToken_StabilityPoolAddressChangedEvent.InputTuple,
		LUSDToken_StabilityPoolAddressChangedEvent.OutputTuple,
		LUSDToken_StabilityPoolAddressChangedEvent.OutputObject
	>;
	...
	'Transfer(address,address,uint256)': TypedContractEvent<
		LUSDToken_TransferEvent.InputTuple,
		LUSDToken_TransferEvent.OutputTuple,
		LUSDToken_TransferEvent.OutputObject
	>;
	...
	[K in `${Uppercase<M['lusd']>}TokenBalanceUpdated(address,uint256)`]: TypedContractEvent<
		LUSDToken_LUSDTokenBalanceUpdatedEvent.InputTuple,
		LUSDToken_LUSDTokenBalanceUpdatedEvent.OutputTuple,
		LUSDToken_LUSDTokenBalanceUpdatedEvent.OutputObject
	>;
} & {
	...
	[K in `${Capitalize<M['trove']>}ManagerAddressChanged(address)`]: TypedContractEvent<
		LUSDToken_TroveManagerAddressChangedEvent.InputTuple,
		LUSDToken_TroveManagerAddressChangedEvent.OutputTuple,
		LUSDToken_TroveManagerAddressChangedEvent.OutputObject
	>;
} & {
...
export type LUSDToken<M extends Modifiers> = BaseContract &
	LUSDTokenTypedContractMethods<M> & {
		...
		getEvent(key: 'Approval'): TypedContractEvent<LUSDToken_ApprovalEvent.InputTuple, LUSDToken_ApprovalEvent.OutputTuple, LUSDToken_ApprovalEvent.OutputObject>;
		getEvent(key: 'BorrowerOperationsAddressChanged'): TypedContractEvent<LUSDToken_BorrowerOperationsAddressChangedEvent.InputTuple, LUSDToken_BorrowerOperationsAddressChangedEvent.OutputTuple, LUSDToken_BorrowerOperationsAddressChangedEvent.OutputObject>;
		getEvent(key: `${Uppercase<M['lusd']>}TokenBalanceUpdated`): TypedContractEvent<LUSDToken_LUSDTokenBalanceUpdatedEvent.InputTuple, LUSDToken_LUSDTokenBalanceUpdatedEvent.OutputTuple, LUSDToken_LUSDTokenBalanceUpdatedEvent.OutputObject>;
		getEvent(key: 'StabilityPoolAddressChanged'): TypedContractEvent<LUSDToken_StabilityPoolAddressChangedEvent.InputTuple, LUSDToken_StabilityPoolAddressChangedEvent.OutputTuple, LUSDToken_StabilityPoolAddressChangedEvent.OutputObject>;
		getEvent(key: 'Transfer'): TypedContractEvent<LUSDToken_TransferEvent.InputTuple, LUSDToken_TransferEvent.OutputTuple, LUSDToken_TransferEvent.OutputObject>;
		getEvent(key: `${Capitalize<M['trove']>}ManagerAddressChanged`): TypedContractEvent<LUSDToken_TroveManagerAddressChangedEvent.InputTuple, LUSDToken_TroveManagerAddressChangedEvent.OutputTuple, LUSDToken_TroveManagerAddressChangedEvent.OutputObject>;
