...
import type { ERC20Mock, ERC20MockInterface } from '../ERC20Mock.js';
...
export class ERC20Mock__factory {
	...
	static createInterface<M extends Modifiers>(
		...
		if (modifiers.abisType === 'normal') return new Interface(_abi) as ERC20MockInterface;

		return new Interface(
			modifyAbi(structuredClone(_abi), modifiers)
		) as ERC20MockInterface;
	}
