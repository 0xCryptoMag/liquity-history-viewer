...
import type { LockupContractFactory, LockupContractFactoryInterface } from '../LockupContractFactory.js';
...
export class LockupContractFactory__factory {
	...
	static createInterface<M extends Modifiers>(
		...
		if (modifiers.abisType === 'normal') return new Interface(_abi) as LockupContractFactoryInterface<M>;
