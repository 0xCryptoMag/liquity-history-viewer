...
import type { LUSDToken, LUSDTokenInterface } from '../LUSDToken.js';
...
export class LUSDToken__factory {
	...
	static createInterface<M extends Modifiers>(
		modifiers: M
	): LUSDTokenInterface<M> {
		if (modifiers.abisType === 'normal') return new Interface(_abi) as LUSDTokenInterface<M>;

		return new Interface(
			modifyAbi(structuredClone(_abi), modifiers)
		) as LUSDTokenInterface<M>;
	}
