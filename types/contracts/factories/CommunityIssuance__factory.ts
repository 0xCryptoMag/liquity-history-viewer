...
import type { CommunityIssuance, CommunityIssuanceInterface } from '../CommunityIssuance.js';
...
export class CommunityIssuance__factory {
	...
	static createInterface<M extends Modifiers>(
		...
		if (modifiers.abisType === 'normal') return new Interface(_abi) as CommunityIssuanceInterface<M>;
