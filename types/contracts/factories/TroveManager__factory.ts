...
import type { TroveManager, TroveManagerInterface } from '../TroveManager.js';
...
export class TroveManager__factory {
	...
	static createInterface<M extends Modifiers>(
		modifiers: M
	): TroveManagerInterface<M> {
		if (modifiers.abisType === 'normal') return new Interface(_abi) as TroveManagerInterface<M>;

		return new Interface(
			modifyAbi(structuredClone(_abi), modifiers)
		) as TroveManagerInterface<M>;
	}
