...
import type { StabilityPool, StabilityPoolInterface } from '../StabilityPool.js';
...
export class StabilityPool__factory {
	...
	static createInterface<M extends Modifiers>(
		modifiers: M
	): StabilityPoolInterface<M> {
		if (modifiers.abisType === 'normal') return new Interface(_abi) as StabilityPoolInterface<M>;

		return new Interface(
			modifyAbi(structuredClone(_abi), modifiers)
		) as StabilityPoolInterface<M>;
	}
