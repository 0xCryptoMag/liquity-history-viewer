...
import type { CollSurplusPool, CollSurplusPoolInterface } from '../CollSurplusPool.js';
...
export class CollSurplusPool__factory {
	...
	static createInterface<M extends Modifiers>(
		...
		if (modifiers.abisType === 'normal') return new Interface(_abi) as CollSurplusPoolInterface<M>;
