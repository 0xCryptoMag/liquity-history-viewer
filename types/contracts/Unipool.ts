...
export type Unipool<M extends Modifiers> = BaseContract &
	...
	getEvent(key: `${Uppercase<M['lqty']>}TokenAddressChanged`): TypedContractEvent<LQTYTokenAddressChangedEvent.InputTuple, LQTYTokenAddressChangedEvent.OutputTuple, LQTYTokenAddressChangedEvent.OutputObject>;
