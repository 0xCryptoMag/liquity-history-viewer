...
type MultiTroveGetterFunctionNameOrSignature<M extends Modifiers> =
...
export interface MultiTroveGetterInterface<M extends Modifiers> extends Interface {
	getFunction(
		nameOrSignature: MultiTroveGetterFunctionNameOrSignature<M>
	): FunctionFragment;
...
export type MultiTroveGetter<M extends Modifiers> = BaseContract &
	MultiTroveGetterTypedContractMethods<M> & {
		...
		getFunction(nameOrSignature: `getMultipleSorted${Capitalize<M['trove']>}s`): TypedContractMethod<[_startIdx: BigNumberish, _count: BigNumberish], [MultiTroveGetter.CombinedTroveDataStructOutput[]], 'view'>;
		getFunction(nameOrSignature: `sorted${Capitalize<M['trove']>}`): TypedContractMethod<[], [string], 'view'>;
